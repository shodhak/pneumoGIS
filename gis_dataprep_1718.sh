...
#cd /Users/sj577/Documents/pneumo_India/hmis_yearly/test
#rm *.csv
#rm -r MonthUpToMarch
...
for dir in *
	do
		...
		Rscript --vanilla /Users/sj577/Documents/pneumo_India/hmis_pneumo_17_18.R ${dir}_ChildHealth.htm ${dir}_pneumo.csv
		pwd
		cd ..
	done
